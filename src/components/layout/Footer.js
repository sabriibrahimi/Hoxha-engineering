        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <div className="flex flex-col">
                  <a href="mailto:Hoxha-ing@live.com" className="hover:text-primary transition-colors">Hoxha-ing@live.com</a>
                  <a href="mailto:hoxha-ku@live.com" className="hover:text-primary transition-colors">hoxha-ku@live.com</a>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 justify-center">
              ...
              <a href="https://www.instagram.com/hoxha.ing/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-primary transition-colors">
