...
const Projects = () => {
  ...
  return (
    <div>
      ...
      <PageBackground
        title="Our Projects"
        subtitle="Explore our completed and ongoing construction projects"
      />
      ...
      <section className="py-24">
        <div className="container">
          <div className="text-center mb-16">
            <span className="text-xl text-primary font-semibold mb-2 block">Our Projects</span>
            <h2 className="text-4xl md:text-5xl font-bold text-secondary mb-6">Latest Works</h2>
          </div>
